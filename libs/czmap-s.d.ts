...
declare namespace CZMAP {
    ...
    export class MapLoader {
        ...
        static loadFormatter(define: FormatterDefine): TableDataFormat | GeoJSONFormat;
        ...
        static loadVolumeLayer(parent: Folder, layerdef: VolumeDefine): VolumeLayer;
...
declare namespace CZMAP {
     ...
     */
    abstract class JSONFeatureFormat extends FeatureFormat {
        constructor();
        /**
         * 获取要素格式的类型
         */
...
declare namespace CZMAP {
     ...
     * @api
     */
    class TableDataFormat extends JSONFeatureFormat {
        private _meta;
        /**
         */
        constructor(option?: TableMeta);
        /**
         * @inheritDoc
         */
...
declare namespace CZMAP {
     ...
     * 坐标串
     */
    type Coordinates = Point | Polyline | Polygon;
    /**
     * 复制点
     * @param src 待复制的对象
     * @param opt 输出目标
...
declare namespace CZMAP {
    ...
    abstract class Layer extends BaseObject {
         ...
         * @param options 图层的定义
         */
        constructor(parent: Folder, options?: LayerOptions);
        /** 获取图层ID */
        get id(): number;
        /** 获取地图对象 */
        get map(): ComMap;
...
declare namespace CZMAP {
    ...
    class ModelLayer extends Folder {
         ...
         * @param option
         */
        showCoordGrid(show: boolean, option?: Grid3DOption): void;
        switchCoordGrid(option?: Grid3DOption): void;
...
declare namespace CZMAP {
    ...
    class TDTilesLayerProperty extends MoveableLayerProperty {
    }
    /**
     * 体数据图层
     */
...
declare namespace CZMAP {
    ...
    interface VolumeLayerOptions extends FolderOptions {
        /** 体数据 */
...
declare namespace CZMAP {
     ...
     * @internal
     */
    abstract class MoveableLayerUE<Type, TLayerDefine2 extends MoveableRtcLayerDefine<Type>> extends MoveableLayer {
        protected _uvlayer: UELayerProxy<Type, TLayerDefine2>;
        constructor(parent: Folder, options: MoveableLayerOptions);
        /**
         * 获取包围盒
         */
...
declare namespace CZMAP {
    ...
    /** @internal */
    class DynActorLayerUE extends MoveableLayerUE<'dynActor', DynActorRtcLayerDefine> {
        private _option;
...
declare namespace CZMAP {
     ...
     * @internal
     */
    abstract class FeatureUE<Type, TLayerDefine extends RtcLayerDefine<Type>> extends FeatureRender {
...
declare namespace CZMAP {
    /** @internal */
    class PointUE extends FeatureUE<'point', PointRtcLayerDefine> {
        private _box;
        /**
         */
        constructor(parent: FeatureLayer);
...
declare namespace CZMAP {
    /** @internal */
    class PolylineUE extends FeatureUE<'polyline', PolylineRtcLayerDefine> {
        private _items;
        private _box;
        constructor(parent: FeatureLayer);
        get box(): BoundingBox;
...
declare namespace CZMAP {
     ...
     * @internal
     */
    class UELayerProxy<Type, TLayerDefine extends RtcLayerDefine<Type>> extends UnrealViewerHelp {
        private _id;
        private _ready;
        private _layer?;
        private _bbox;
        ...
        isValid(): boolean;
        /** 创建图层 */
        createLayer(type: Type, define: TLayerDefine): Promise<void>;
        /** 飞行到图层 */
        ...
        /** 更新图层 */
        updateLayer(option: Partial<TLayerDefine>): Promise<void>;
...
declare namespace CZMAP {
    ...
    /** @internal */
    class WrappedLayerUE extends MoveableLayerUE<'wrapped', WrappedRtcLayerDefine> {
        private _option;
...
declare namespace CZMAP {
    ...
    abstract class MapView extends BaseObject {
        ...
        /** */
        abstract getGridTool(): GridTool;
        /**
         * 绘图工具
         */
        abstract getDrawTool(): DrawTool;
        /**
         * 测量功能
         */
        abstract getMeasureTool(): MeasureTool;
        /**
         * 创建路径漫游工具
         */
        abstract createPathRoam(): PathRoam;
        /**
         * 创建轴向平面
         */
        abstract createClipPlane(option: ClipPlaneOption): ClipPlaneBase;
        /**
         * 创建巷道效果工具
         */
        abstract createTunnelEffct(): TunnelEffct;
        /**
         * 创建巷道透明工具
         */
        abstract createTunnelTransparent(): TunnelTransparent;
        /**
         * 创建地形开挖
         */
        abstract createTerrainClips(options: ClipTerrainOption): any;
        /**
         * 清除地形开挖
         */
        abstract clearTerrainClips(): void;
        /** 创建信息窗口 */
        abstract createInfoWindow(option: InfoWindowOption): InfoWindow;
        /** 移除信息窗口 */
        removeInfoWindow(infoWindow: InfoWindow): boolean;
    }
}
declare namespace CZMAP {
...
declare namespace CZMAP {
    class MapView2D extends MapView {
        ...
        getMeasureTool(): MeasureTool;
        createTunnelEffct(): TunnelEffct;
        createTunnelTransparent(): TunnelTransparent;
        createTerrainClips(options: any): void;
        ...
        getExtend(): Extent;
        createPathRoam(): PathRoam;
        createClipPlane(option: ClipPlaneOption): ClipPlaneBase;
        /** 创建信息窗口 */
        createInfoWindow(option: InfoWindowOption): InfoWindow;
        /**
         * ZMap2D.Map 对象
         */
        get zmap2d(): any;
...
declare namespace CZMAP {
    ...
    class MapViewUE extends MapView {
        ...
        createTunnelEffct(): TunnelEffct;
        createTunnelTransparent(): TunnelTransparent;
        createTerrainClips(options: ClipTerrainOption): void;
        clearTerrainClips(): void;
        /** 创建信息窗口 */
        createInfoWindow(option: InfoWindowOption): InfoWindow;
    }
...
declare namespace CZMAP {
    ...
    /** 图层定义 */
    export interface RtcLayerDefine<Type> {
        /** 图层是否显示 */
        visible?: boolean;
    }
    /** 影像图层定义 */
    ...
    /** 可移动的图层 */
    export interface MoveableRtcLayerDefine<T> extends RtcLayerDefine<T> {
        /** 位置 */
        position?: Point;
        /** 旋转（HPR） */
        rotate?: Point;
    ...
    export class UnrealViewerAPI extends Observable {
         ...
         * @returns 返回图层的ID
         */
        createLayer<Type>(type: Type, define: RtcLayerDefine<Type>): Promise<number>;
        /**
         * 更新图层
         * @param layerID 图层ID
         * @param option 图层定义
...
declare namespace CZMAP {
    ...
    interface WallStyleOption extends StyleOption {
        /** 填充颜色 */
        color?: string;
        /** 填充纹理 */
        image?: string;
    ...
    /** 折线样式 */
    class WallStyle extends Style implements WallStyleOption {
        constructor(style?: StrokeStyleOption);
        protected _initDefines(): void;
        get color(): string;
        set color(v: string);
...
declare namespace CZMAP {
    ...
    abstract class BoxBasedTool extends BaseTool {
        private _box;
        private _center;
        private _size;
        private _gsize;
        constructor(view: MapView, box: BoundingBox);
        get box(): BoundingBox;
        get center(): Point;
        get size(): Point;
        get gsize(): Point;
    }
    abstract class ClipPlaneBase extends BoxBasedTool {
        constructor(view: MapView, box: BoundingBox);
        get color(): string;
    ...
    abstract class AxisClipPlane extends ClipPlaneBase {
        constructor(view: MapView, box: BoundingBox);
        get axis(): Axis;
        set axis(axis: Axis);
        get distance(): number;
    ...
    abstract class PathClipPlanes extends ClipPlaneBase {
...
declare namespace CZMAP {
    ...
    abstract class DrawTool extends BaseTool {
         ...
         * @param {*} style
         */
        abstract add(geo: Geometry, style: DrawStyle): string;
        /**
         * 移除
         * @param {*} geo
         */
         ...
         * @param {*} opt_this
         */
        abstract draw(type: GeometryType, callback: DrawCallback, style?: DrawStyle, opt_this?: object): void;
        /**
         * 停止绘制
         */
         ...
         * 画点
         */
        abstract drawPoint(callback: DrawCallback, style?: DrawStyle, opt_this?: object): void;
        /**
         * 画线
         */
        abstract drawPolyline(callback: DrawCallback, style?: DrawStyle, opt_this?: object): void;
        /**
         * 画圆
         */
        abstract drawCircle(callback: DrawCallback, style?: DrawStyle, opt_this?: object): void;
        /**
         * 画矩形
         */
        abstract drawRect(callback: DrawCallback, style?: DrawStyle, opt_this?: object): void;
        /**
         * 画多边形
         */
        abstract drawPolygon(callback: DrawCallback, style?: DrawStyle, opt_this?: object): void;
    }
}
declare namespace CZMAP {
    ...
    abstract class GridTool extends BaseTool {
        constructor(view: MapView);
        /**
         * 创建网格
         */
        abstract create(option: GridOption): string;
        /**
         * 删除网格
         * @param name
         */
...
declare namespace CZMAP {
    ...
    interface InfoWindowOption {
        ...
        offsetY?: number;
        /** 关闭中 */
        onClosing?: (iw: InfoWindow) => boolean;
        /** 已关闭 */
        onClosed?: (iw: InfoWindow) => void;
    }
    /** 信息窗口 */
    abstract class InfoWindow extends BaseTool {
        private _dom;
        private _overlayDom;
        private _contentDom;
        private _arrowDom;
        ...
        /** 已关闭 */
        private _onClosed?;
        constructor(view: MapView, option: InfoWindowOption);
        /** 位置 */
        get position(): Point;
...
declare namespace CZMAP {
    ...
    abstract class MeasureCallbackParam {
        ...
        /** 距离 */
        private _value;
        constructor(points: Point[], value: number);
        /** 测量类型 */
        abstract get type(): ('distance' | 'area');
        /** 测量的点位 */
        get points(): Point[];
        /** 测量结果 */
        get value(): number;
    ...
    class AreaCallbackParam extends MeasureCallbackParam {
        private _center;
        constructor(points: Point[], center: Point, area: number);
        /** @override */
        get type(): 'area';
        /** 距离 */
        get area(): number;
     ...
     * 测量工具
     */
    abstract class MeasureTool extends BaseTool {
        /**
         */
        constructor(view: MapView);
        /**
         * 测量距离
         */
        abstract distance(option?: MeasureDistOption): void;
        /**
         * 测量面积
         */
        abstract arae(option?: MeasureAreaOption): void;
        /**
         * 清除测量
         */
        abstract clear(): void;
...
declare namespace CZMAP {
    ...
    type PathDataPointOld = {
        cameraPoint: Point;
        targetPoint?: Point;
        speed?: number;
    };
    type PathDataPointLike = (PathDataPoint & PathDataPointOld) | Point;
    type PathRomaData = PathDataPointLike[];
    /**
     * 路径点类
     */
    class PathNode {
...
declare namespace CZMAP {
    ...
    abstract class TunnelEffct extends BaseTool {
        /**
         */
        constructor(view: MapView);
        /**
...
declare namespace CZMAP {
     ...
     * 巷道模型（双层模型）透视（透明）处理类
     */
    abstract class TunnelTransparent extends BaseTool {
        constructor(view: MapView);
        /**
         * 初始化
         * @param {*} options
...
declare namespace CZMAP {
    class AxisClipPlane3D extends AxisClipPlane {
        private _dim;
        private _plane;
        private _entity;
    ...
    class PathClipPlane3D extends PathClipPlanes {
        private _entity;
...
declare namespace CZMAP {
    class DrawTool3D extends DrawTool {
        view3d: MapView3D;
        private _3dDrawTool;
        private _entity;
        private _entities;
         ...
         * @param {*} style
         */
        add(geo: Geometry, style: DrawStyle): string;
        /**
         *
         */
        addPoint(geo: GeoPoint, style?: DrawStyle): string;
        /**
         *
         */
        addPolyline(geo: GeoPolyline, style?: DrawStyle): string;
        /**
         *
         */
        addPolygon(geo: GeoPolygon, style: DrawStyle): string;
        /**
         *
         */
        addRect(geo: GeoRectangle, style: DrawStyle): string;
        addCircle(geo: GeoCircle, style: DrawStyle): string;
        addDynamicCircle(geo: GeoCircle, dynStyle?: DynamicCircleOption): string;
        /**
         * 移除
         */
         ...
         * @param {*} opt_this
         */
        draw(type: GeometryType, callback: DrawCallback, style: DrawStyle, opt_this?: object): void;
        stopDraw(): void;
        /**
         * 画点
         */
        drawPoint(callback: any, style: any, opt_this: any): void;
        /**
         * 画线
         */
        drawPolyline(callback: any, style: any, opt_this: any): void;
        /**
         * 画圆
         */
        drawCircle(callback: any, style: any, opt_this: any): void;
        /**
         * 画矩形
         */
        drawRect(callback: any, style: any, opt_this: any): void;
        /**
         * 画多边形
         */
        drawPolygon(callback: any, style: any, opt_this: any): void;
    }
}
declare namespace CZMAP {
    interface Grid3DOption extends GridOption {
        flatMode?: boolean;
    }
    class GridTool3D extends GridTool {
        private _view3d;
        private _entities;
        private _grids;
        private _rid;
         ...
         */
        constructor(view: MapView3D);
        create(option: Grid3DOption): string;
...
declare namespace CZMAP {
    class InfoWindow3D extends InfoWindow {
...
declare const ZMap3DLib: any;
declare const ZMAPGEOMETRY: any;
declare const $: any;
declare namespace CZMAP {
    class DistanceResult {
        ...
        zdiff: number;
        xydiff: number;
        inc(added: DistanceResult): this;
    }
    class DistUtils {
        static computeDistance(p0: Point, p1: Point, ellipsold?: Cesium.Ellipsoid): DistanceResult;
        static computeDistances(pts: Point[]): DistanceResult;
        static computeCenter(pts: Point[]): Point;
        static formatDistance(distance: number): string;
        static scratch_PickGlobe_Ray: Cesium.Ray;
        static scratch_PickGlobe_DepthIntersection: Cesium.Cartesian3;
        static scratch_PickGlobe_RayIntersection: Cesium.Cartesian3;
        static pickGlobe(viewer: Cesium.Viewer, mousePosition: Cesium.Cartesian2, result?: Cesium.Cartesian3): Cesium.Cartesian3;
    }
    class Distance3DCallbackParam extends DistanceCallbackParam {
        constructor(points: Point[], dr: DistanceResult);
        /** 高程差 */
        zdiff: number;
        /** 水平距离 */
        xydiff: number;
     ...
     * 三维测量工具
     */
    class MeasureTool3D extends MeasureTool {
        private tool;
        /**
         */
        constructor(view: MapView3D);
...
declare namespace CZMAP {
     ...
     * 路径点类
     */
    class PathNode3D extends PathNode {
        /** 笛卡尔坐标 */
        position3D: Cesium.Cartesian3;
        constructor(data: PathDataPointLike);
    }
    export class PathRoam3D extends PathRoam {
        /**
         */
        private view3d;
        /** 上一帧时间 */
        ...
        /** 计算两点间距离 */
        protected _calcDistance(a: PathNode3D, b: PathNode3D): number;
    }
    export {};
}
declare namespace CZMAP {
     ...
     * 基于巷道的纹理动画
     */
    class TunnelEffct3D extends TunnelEffct {
        /**
         */
        private view3d;
        private models;
...
declare namespace CZMAP {
    class TunnelTransparent3D extends TunnelTransparent {
        /**
         */
        private view3d;
        /**
...
declare namespace CZMAP {
    /** @internal */
    class InfoWindowUE extends InfoWindow {
        private _id;
        private _uvapi;
        constructor(view: MapView, option: InfoWindowOption);
        close(): boolean;
...
declare namespace CZMAP {
     ...
     * 路径点类
     */
    class PathNodeUE extends PathNode {
        /** 笛卡尔坐标 */
        position3D: Cesium.Cartesian3;
        constructor(data: PathDataPointLike);
    }
...
declare namespace CZMAP {
     ...
     * @returns 偏移后的点
     */
    function calcOffsetPoint(pt: CZMAP.Point, ox: number, oy: number, oz: number, isGeographical?: boolean): number[];
    /**
     * 计算指定坐标附近指定偏移坐标
     * @param position 目标点
     * @param dist 偏移距离
     ...
     * @returns
     */
    function calcOffsetPoint2(position: CZMAP.Point, dist: number, heading: number, pitch: number, isGeographical?: boolean): number[];
    /**
     * 延线段方向计算线段终点偏移后坐标
     * @param p0 线段起点坐标
     * @param p1 线段终点坐标
     ...
     * @returns
     */
    function calcLineOffsetPoint(p0: Point, p1: Point, ox: number, oy: number, oz: number, isGeographical?: boolean): Point;
    /**
     * 延线段方向计算线段终点偏移后坐标
     * @param p0 线段起点坐标
     * @param p1 线段终点坐标
     ...
     * @returns
     */
    function transformModelCoordinates(modelLayer: CZMAP.ModelLayer, pts: CZMAP.Polyline, srcSrs: string, distSrs?: string): Point[];
}
declare namespace CZMAP {
    /** 切割保留参数 */
    enum CutRetain {
    ...
    class ModelCutHelper {
         ...
         */
        addAxisPlane(clip: AxisClipPlane, retain: CutRetain): void;
        /**
         * 添加平面切割
         * @param axis 切割轴向
         ...
         * @param retain 保留的模型信息
         */
        addComplex(path: Polyline, clip: AxisClipPlane, retain: CutRetain): void;
        /**
         * 执行切割
         * @param option 切割参数
...
declare namespace CZMAP {
    ...
    class ModelLayerHelper {
         ...
         * @returns
         */
        static createClipPlane(layer: ModelLayer, type: ClipPlaneType): ClipPlaneBase;
        /**
         * 创建包围盒
         * @param layer
         * @returns
...
declare namespace CZMAP {
    ...
    class CesiumAttrib {
        ...
        static getColor(val: string | Cesium.Color, def?: Cesium.Color): Cesium.Color;
