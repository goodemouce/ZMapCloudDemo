namespace DemoEvents
{
    ...
    demo.addButton('绑定事件', () => {
        ...
        /// 点击事件
        eventObjects.push(events.on(CZMAP.MapEventsType.MOUSE_CLICK, (e:CZMAP.MapMouseEventUE) => { 
            console.info(e); 
        ...
        /// 右键点击事件
        eventObjects.push(events.on(CZMAP.MapEventsType.MOUSE_RCLICK, (e:CZMAP.MapMouseEvent) => {
    ...
    demo.addButton('拾取坐标', () => {
        ...
        {
            /// 注册点击事件
            clickEvent = map.view.events.on(CZMAP.MapEventsType.MOUSE_CLICK, (e:CZMAP.MapMouseEvent3D) => {
                /// 获取点击的坐标
    ...
    /// 显示模型的属性信息
    function showProperties(props:Record<string, any>)
    {
